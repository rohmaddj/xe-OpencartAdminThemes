      ...
      <div class="panel-body">
        <form class="form-horizontal">
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <button type="button" id="button-upload" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-info"><i class="fa fa-upload"></i> <?php echo $button_upload; ?></button>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              <br />
              <button type="button" id="button-continue" class="btn btn-secondary" disabled="disabled"><i class="fa fa-check"></i> <?php echo $button_continue; ?></button>
            </div>
          </div>
        </form>
      </div>
